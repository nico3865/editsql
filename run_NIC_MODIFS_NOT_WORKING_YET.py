...
from model_util import Metrics, evaluate_utterance_sample, evaluate_interaction_sample, evaluate_interaction_sample_NIC, evaluate_interaction_sample_NIC_2, \
...
def evaluate(model, data, params, last_save_file, split):
    ...
    if params.interaction_level or params.use_predicted_queries:
        ...
        print("type(examples)")
        print(type(examples))
        #params.interaction_level = False
        print("params.interaction_level:")
        print(params.interaction_level)
        print("-------------------")
        if params.interaction_level:
            print("--> evaluate_interaction_sample")
            evaluate_interaction_sample(        #evaluate_interaction_sample(. # evaluate_interaction_sample_NIC
                examples,
                model,
                name=full_name,
            ...
            print("--> evaluate_using_predicted_queries")
